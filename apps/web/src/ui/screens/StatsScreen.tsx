...
import { buildWeeks, periodStats } from '@workpulse/core';
import {
  addDays,
  endOfWeek,
  formatClockish,
          ...
          {weeks.length === 0 ? (
            ...
            <>
                ...
                {weeks.map((w) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <div
                        style={{ height: 1, width: '100%', background: 'var(--hairline-strong)' }}
                      />
                      <div
                        style={{
                          width: '100%',
              ...
              <p className="small muted center" style={{ marginTop: 10 }}>
                Solde cumulé actuel :{' '}
                <strong
                  className={weeks[weeks.length - 1].carryOut >= 0 ? 'value-pos' : 'value-neg'}
                >
